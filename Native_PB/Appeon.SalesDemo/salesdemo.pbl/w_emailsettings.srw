...
this.Control[]={this.ddlb_proxytype,&
...
event open;
sle_server.text   = str_email.ls_server
sle_userid.text   = str_email.ls_userid
sle_password.text = str_email.ls_password
sle_port.text     = str_email.ls_port
sle_timeout.text     = str_email.ls_timeout
sle_outputlog.text     = str_email.ls_outputlog
...
if str_email.ls_useproxy = 'Y' then
	...
	sle_proxyhost.text = str_email.ls_proxyhost
	sle_proxyport.text = str_email.ls_proxyport
	sle_proxyuserid.text = str_email.ls_proxyuserid
	sle_proxypassword.text = str_email.ls_proxypassword
	choose case str_email.ls_proxytype
		case '0'
...
event clicked;If sle_userid.text = "" Then
